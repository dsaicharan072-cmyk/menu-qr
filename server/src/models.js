...
export const Restaurant = mongoose.model('Restaurant', new mongoose.Schema({name:String,slug:{type:String,unique:true},tagline:String,address:String,phone:String,cuisine:String}, {timestamps:true}));
